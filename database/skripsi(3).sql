...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 01 Nov 2020 pada 10.33
-- Versi server: 5.7.31
-- Versi PHP: 7.3.21
...
INSERT INTO `pinjaman` (`no_pk`, `nama_debitor`, `alamat`, `jumlah_pinjam`, `lama_pinjam`, `angsuran_pokok`, `bunga`, `tanggal_realisasi`, `tanggal_jatuh_tempo`, `jaminan`, `no_hp`, `status`) VALUES
('500/PK/KSB/10/2020', 'Javiera', 'Jalan Ahmad Yani', 3000000, '24', 125000, 37500, '2020-10-31', '2022-10-31', 'Buku Tabungan', '087876543', 'Belum Lunas');
