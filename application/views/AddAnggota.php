      ...
      <form class="form-horizontal" method="post" action="<?= base_url('Anggota/save');?>">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control <?= isset($this->session->flashdata('error')['no_identitas']) ? 'is-invalid':'' ?>" id="no_identitas" name="no_identitas" placeholder="No Identitas">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                ...
                <input type="text" class="form-control datetimepicker-input <?= isset($this->session->flashdata('error')['tanggal_lahir']) ? 'is-invalid':'' ?>" data-target="#datetimepicker4" name="tanggal_lahir">
              </div>
            </div>
            <!-- /.input group -->
          </div>
